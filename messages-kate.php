...
<div class="d-block" id="messages-kate">
...
<div class="messages--bar justify-content-around align-items-center">
    <form class="messages--form" id="messages_form">
        <input type="text" class="messages--input" id="messages-input" placeholder="Message..." aria-label="Recipient's username" aria-describedby="button-addon2">
        <button class="messages--send" type="submit" id="messages-btn"><i class="bi bi-send"></i></button>
    </form>
    <i class="bi bi-mic"></i>
</div>
